...
type
  ...
  TFastMM_MemoryManagerEventType = (
    ...
    mmetDebugBlockHeaderCorruption, mmetDebugBlockFooterCorruption, mmetDebugBlockModifiedAfterFree,
...
{$ENDIF}
  ...
  TFastMM_WalkAllocatedBlocksBlockType = (btLargeBlock, btMediumBlockSpan, btMediumBlock, btSmallBlockSpan, btSmallBlock);
  ...
  TFastMM_ConvertStackTraceToText = function(APReturnAddresses: PNativeUInt; AMaxDepth: Cardinal; APBuffer, APBufferEnd: PWideChar): PWideChar;
...
function FastMM_LogStateToFile(const AFilename: string; const AAdditionalDetails: string = ''; ALockTimeoutMilliseconds: Cardinal = 1000): Boolean;
...
function FastMM_NoOpConvertStackTraceToText(APReturnAddresses: PNativeUInt; AMaxDepth: Cardinal; APBufferPosition, APBufferEnd: PWideChar): PWideChar;
...
var
  ...
  FastMM_OutputDebugStringEvents: TFastMM_MemoryManagerEventTypeSet = [mmetDebugBlockDoubleFree, mmetDebugBlockReallocOfFreedBlock,
    mmetDebugBlockHeaderCorruption, mmetDebugBlockFooterCorruption, mmetDebugBlockModifiedAfterFree, mmetVirtualMethodCallOnFreedObject,
    mmetAnotherThirdPartyMemoryManagerAlreadyInstalled, mmetCannotInstallAfterDefaultMemoryManagerHasBeenUsed,
    mmetCannotSwitchToSharedMemoryManagerWithLivePointers];
  { The events that are logged to file. }
  FastMM_LogToFileEvents: TFastMM_MemoryManagerEventTypeSet = [mmetDebugBlockDoubleFree, mmetDebugBlockReallocOfFreedBlock,
    mmetDebugBlockHeaderCorruption, mmetDebugBlockFooterCorruption, mmetDebugBlockModifiedAfterFree, mmetVirtualMethodCallOnFreedObject,
    mmetAnotherThirdPartyMemoryManagerAlreadyInstalled, mmetCannotInstallAfterDefaultMemoryManagerHasBeenUsed,
    mmetCannotSwitchToSharedMemoryManagerWithLivePointers];
  { The events that are displayed in a message box. }
  FastMM_MessageBoxEvents: TFastMM_MemoryManagerEventTypeSet = [mmetDebugBlockDoubleFree, mmetDebugBlockReallocOfFreedBlock,
    mmetDebugBlockHeaderCorruption, mmetDebugBlockFooterCorruption, mmetDebugBlockModifiedAfterFree, mmetVirtualMethodCallOnFreedObject,
    mmetAnotherThirdPartyMemoryManagerAlreadyInstalled, mmetCannotInstallAfterDefaultMemoryManagerHasBeenUsed,
    mmetCannotSwitchToSharedMemoryManagerWithLivePointers];
  ...
  FastMM_MemoryLeakDetailMessage_NormalBlock: PWideChar = 'A memory block has been leaked. The size is: {3}'#13#10#13#10 +
    ...
    'Current memory dump of {10} bytes starting at pointer address {11}:'#13#10 + '{12}'#13#10'{13}'#13#10;
  FastMM_MemoryLeakDetailMessage_DebugBlock: PWideChar = 'A memory block has been leaked. The size is: {3}'#13#10#13#10 +
    ...
    '{6}'#13#10#13#10'The block is currently used for an object of class: {8}'#13#10#13#10 + 'The allocation number is: {9}'#13#10#13#10 +
    'Current memory dump of {10} bytes starting at pointer address {11}:'#13#10 + '{12}'#13#10'{13}'#13#10;
  ...
  FastMM_MemoryLeakSummaryMessage_LeakDetailLoggedToEventLog: PWideChar = 'This application has leaked memory. ' +
    'The leaks ordered by size are:'#13#10'{14}'#13#10#13#10 + 'Memory leak detail was logged to {16}'#13#10;
  ...
  FastMM_DebugBlockDoubleFree: PWideChar = 'An attempt was made to free a block that has already been freed.'#13#10#13#10 +
    'The block size is {3}.'#13#10#13#10 + 'The block was allocated by thread 0x{4}, and the stack trace (return addresses) at the time was:' +
    '{6}'#13#10#13#10'This block was freed by thread 0x{5}, and the stack trace (return addresses) at the time was:' + '{7}'#13#10#13#10 +
  ...
  FastMM_BlockModifiedAfterFreeMessage: PWideChar = 'A memory block was modified after it was freed.'#13#10#13#10 +
    'The block size is {3}.'#13#10#13#10 + 'Modifications were detected at offsets (with lengths in brackets): {15}.'#13#10#13#10 +
    'The block was allocated by thread 0x{4}, and the stack trace (return addresses) at the time was:' +
    '{6}'#13#10#13#10'This block was freed by thread 0x{5}, and the stack trace (return addresses) at the time was:' + '{7}'#13#10#13#10 +
    'The allocation number is: {9}'#13#10#13#10 + 'Current memory dump of {10} bytes starting at pointer address {11}:'#13#10 +
    '{12}'#13#10'{13}'#13#10;
  ...
  FastMM_BlockFooterCorruptedMessage_AllocatedBlock: PWideChar = 'A memory block footer has been corrupted.'#13#10#13#10 +
    'The block size is {3}.'#13#10#13#10 + 'The block was allocated by thread 0x{4}, and the stack trace (return addresses) at the time was:' +
    '{6}'#13#10#13#10 + 'The allocation number is: {9}'#13#10#13#10 + 'Current memory dump of {10} bytes starting at pointer address {11}:'#13#10 +
    '{12}'#13#10'{13}'#13#10;
  ...
  FastMM_VirtualMethodCallOnFreedObjectMessage: PWideChar = 'A virtual method was called on a freed object.'#13#10#13#10 +
    'Freed object class: {8}'#13#10#13#10 + 'Virtual method: {17}'#13#10#13#10 + 'The block size is {3}.'#13#10#13#10 +
    'The block was allocated by thread 0x{4}, and the stack trace (return addresses) at the time was:' +
    '{6}'#13#10#13#10'This block was freed by thread 0x{5}, and the stack trace (return addresses) at the time was:' +
    '{7}'#13#10#13#10'The stack trace for the virtual call that lead to this error is:' + '{24}'#13#10#13#10 +
    'The allocation number is: {9}'#13#10#13#10 + 'Current memory dump of {10} bytes starting at pointer address {11}:'#13#10 +
    '{12}'#13#10'{13}'#13#10;
  ...
  FastMM_LogStateToFileTemplate: PWideChar = 'FastMM State Capture:'#13#10 + '---------------------'#13#10 + '{18}K Allocated'#13#10 +
    '{19}K Overhead'#13#10 + '{20}% Efficiency'#13#10#13#10 + 'Usage Detail:'#13#10;
...
{$ENDIF}
  ...
  TMemoryLeakType = (mltUnexpectedLeak, mltExpectedLeakRegisteredByPointer, mltExpectedLeakRegisteredByClass, mltExpectedLeakRegisteredBySize);
  ...
  TFastMM_LegacyConvertStackTraceToText = function(APReturnAddresses: PNativeUInt; AMaxDepth: Cardinal; APBuffer: PAnsiChar): PAnsiChar;
...
{$ENDIF}
    ...
    { 128 byte jumps }
    1472, 1600, 1728, 1856, 1984, 2112, 2240, 2368, 2496, CMaximumSmallBlockSize // = 2624
    );
...
function DebugLibrary_LogStackTrace_Legacy(APReturnAddresses: PNativeUInt; AMaxDepth: Cardinal; APBuffer: PAnsiChar): PAnsiChar;
...
begin
  ...
  Result := @PByte(@Self)[UserSize + (StackTraceEntryCount * SizeOf(Pointer)) + (CDebugBlockHeaderSize + CDebugBlockFooterCheckSumSize)];
end;
...
function OS_AllocateVirtualMemory(ABlockSize: NativeInt; AAllocateTopDown: Boolean; AReserveOnlyNoReadWriteAccess: Boolean): Pointer;
begin
...
function OS_AllocateVirtualMemoryAtAddress(APAddress: Pointer; ABlockSize: NativeInt; AReserveOnlyNoReadWriteAccess: Boolean): Boolean;
begin
  if AReserveOnlyNoReadWriteAccess then
  begin
  ...
  begin
    Result := (Winapi.Windows.VirtualAlloc(APAddress, ABlockSize, MEM_RESERVE, PAGE_READWRITE) <> nil) and
      (Winapi.Windows.VirtualAlloc(APAddress, ABlockSize, MEM_COMMIT, PAGE_READWRITE) <> nil);
  end;
...
begin
  ...
  begin
    ...
    begin
      if (LMemInfo.Protect and (PAGE_READONLY or PAGE_READWRITE or PAGE_EXECUTE or PAGE_EXECUTE_READ or PAGE_EXECUTE_READWRITE or
...
begin
  ...
  AFileHandle := Winapi.Windows.CreateFileW(APFileName, GENERIC_READ or GENERIC_WRITE, FILE_SHARE_READ, nil, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, 0);
...
function OpenOrCreateTextFile(APFileName: PWideChar; AAddLineBreakToExistingFile: Boolean; var AFileHandle: THandle): Boolean;
const
...
var
  ...
  begin
    { Do some basic pointer checks:  Must be pointer aligned and beyond 64K. (The low 64K is never readable, at least
      under Windows.) }
    if (NativeUInt(APAddress) <= 65535) or (NativeUInt(APAddress) and (SizeOf(Pointer) - 1) <> 0) then
    begin
      Exit(False);
    end;

    { Fetch the memory access flags for the region surrounding the pointer, if required. }
    if (NativeUInt(APAddress) < NativeUInt(LMemoryRegionInfo.RegionStartAddress)) or
      (NativeUInt(APAddress) - NativeUInt(LMemoryRegionInfo.RegionStartAddress) >= LMemoryRegionInfo.RegionSize) then
    begin
      OS_GetVirtualMemoryRegionInfo(APAddress, LMemoryRegionInfo);
    end;

    { The address must be readable. }
    Result := (not LMemoryRegionInfo.RegionIsFree) and (marRead in LMemoryRegionInfo.AccessRights);
  end;
...
{ Returns True if AClassPointer points to a class VMT }
  ...
  begin
    ...
    if (ADepth < 1000) and (NativeUInt(AClassPointer) > 65535) and IsValidVMTAddress(Pointer(PByte(AClassPointer) + vmtSelfPtr)) and
    ...
    begin
      ...
      Result := IsValidVMTAddress(LParentClassSelfPointer) and InternalIsValidClass(LParentClassSelfPointer^, ADepth + 1);
    end
    else
      Result := False;
  end;
...
begin
  ...
  if (LStringLength <= 0) or (LStringLength >= (AAvailableSpaceInBlock - SizeOf(StrRec)) div LElementSize) then
  begin
    Exit(sdtNotAString);
  end;
...
function AppendTextToBuffer(APSource: PWideChar; ACharCount: Integer; APTarget, APTargetBufferEnd: PWideChar): PWideChar; overload;
begin
  Result := APTarget;
...
begin
  ...
  case ABlockContentType of
    0:
      Result := AppendTextToBuffer(CUnknown, length(CUnknown), Result, APTargetBufferEnd);
    1:
      Result := AppendTextToBuffer(CAnsiString, length(CAnsiString), Result, APTargetBufferEnd);
    2:
      Result := AppendTextToBuffer(CUnicodeString, length(CUnicodeString), Result, APTargetBufferEnd);
...
{ Copies a token value to the buffer and sets the pointer to the token in the values array.  Copies up to the size of
  the target buffer. }
function AddTokenValue(var ATokenValues: TEventLogTokenValues; ATokenID: Integer; APTokenValue: PWideChar; ACharCount: Integer;
...
function AddTokenValue_HexDump(var ATokenValues: TEventLogTokenValues; ATokenID: Integer; APBlock: PByte; ANumBytes: Integer;
  APTokenValueBufferPos, APBufferEnd: PWideChar): PWideChar;
var
...
function AddTokenValue_ASCIIDump(var ATokenValues: TEventLogTokenValues; ATokenID: Integer; APBlock: PByte; ANumBytes: Integer;
  APTokenValueBufferPos, APBufferEnd: PWideChar): PWideChar;
var
  LTempBuffer     : array [0 .. CMemoryDumpMaxBytes * 5] of WideChar; // Worst case scenario:  Allow for CRLF after every byte
  LPTarget        : PWideChar;
...
begin
  ...
  begin
    LPBuffer := FastMM_ConvertStackTraceToText(APStackTrace, AStackTraceEntryCount, LPBuffer, @LStackTraceBuffer[high(LStackTraceBuffer)]);
  end;

  Result := AddTokenValue(ATokenValues, ATokenID, LStackTraceBuffer, CharCount(LPBuffer, @LStackTraceBuffer), Result, APBufferEnd);
end;
...
function AddTokenValues_CurrentDateAndTime(var ATokenValues: TEventLogTokenValues; APTokenValueBufferPos, APBufferEnd: PWideChar): PWideChar;
var
...
function AddTokenValue_BlockContentType(var ATokenValues: TEventLogTokenValues; ATokenID: Integer; ABlockContentType: NativeUInt;
  APTokenValueBufferPos, APBufferEnd: PWideChar): PWideChar;
const
...
function AddTokenValues_GeneralTokens(var ATokenValues: TEventLogTokenValues; APTokenValueBufferPos, APBufferEnd: PWideChar): PWideChar;
begin
  Result := AddTokenValues_CurrentDateAndTime(ATokenValues, APTokenValueBufferPos, APBufferEnd);
  Result := AddTokenValue(ATokenValues, CEventLogTokenEventLogFilename, @EventLogFilename, GetStringLength(@EventLogFilename), Result, APBufferEnd);
end;

function AddTokenValues_BlockTokens(var ATokenValues: TEventLogTokenValues; APBlock: Pointer; APBuffer, APBufferEnd: PWideChar): PWideChar;
var
...
begin
  ...
  Result := AddTokenValue_BlockContentType(ATokenValues, CEventLogTokenObjectClass, LBlockContentType, Result, APBufferEnd);

  { Add the token for the block adddress in hex. }
  Result := AddTokenValue_Hexadecimal(ATokenValues, CEventLogTokenBlockAddress, NativeUInt(APBlock), Result, APBufferEnd);
  ...
  begin
    ...
    Result := AddTokenValue_Hexadecimal(ATokenValues, CEventLogTokenAllocatedByThread, LPDebugBlockHeader.AllocatedByThread, Result, APBufferEnd);

    Result := AddTokenValue_NativeUInt(ATokenValues, CEventLogTokenAllocationNumber, LPDebugBlockHeader.AllocationNumber, Result, APBufferEnd);

    Result := AddTokenValue_StackTrace(ATokenValues, CEventLogTokenAllocationStackTrace, LPDebugBlockHeader.DebugFooter_AllocationStackTracePtr,
      LPDebugBlockHeader.StackTraceEntryCount, Result, APBufferEnd);

    if LBlockHeader and CBlockIsFreeFlag = CBlockIsFreeFlag then
    begin
      Result := AddTokenValue_Hexadecimal(ATokenValues, CEventLogTokenFreedByThread, LPDebugBlockHeader.FreedByThread, Result, APBufferEnd);
...
function SubstituteTokenValues(APTemplate: PWideChar; const ATokenValues: TEventLogTokenValues; APBuffer, APBufferEnd: PWideChar): PWideChar;
const
  CTokenStartChar = '{';
  CTokenEndChar   = '}';
var
...
begin
  ...
  LPBufferPos := AddTokenValue(LTokenValues, CEventLogTokenVirtualMethodName, APMethodName, GetStringLength(APMethodName), LPBufferPos, LPBufferEnd);
  AddTokenValue_StackTrace(LTokenValues, CEventLogTokenVirtualMethodCallOnFreedObject, @TFastMM_FreedObject.FVirtualMethodStackTrace,
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Inc(LOffset);
        if (LOffset >= APDebugBlockHeader.UserSize) or (LPUserArea[LOffset] = CDebugFillPattern1B) then
        begin
          Break;
        end;
      end;
...
begin
  Result := CheckDebugBlockHeaderAndFooterCheckSumsValid(APDebugBlockHeader) and CheckDebugBlockFillPatternIntact(APDebugBlockHeader);
end;
...
begin
  ...
  begin
    ...
    if (LPLargeBlockManager.PendingFreeList <> nil) and (LPLargeBlockManager.LargeBlockManagerLocked = 0) and
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (LPLargeBlockManager.LargeBlockManagerLocked = 0) and (AtomicExchange(LPLargeBlockManager.LargeBlockManagerLocked, 1) = 0) then
        begin
...
begin
  Result := PMediumBlockSpanHeader(NativeUInt(APMediumBlock) - (PMediumBlockHeader(APMediumBlock)
    [-1].MediumBlockSpanOffsetMultiple shl CMediumBlockAlignmentBits));
end;
...
begin
  ...
  PMediumBlockHeader(APMediumBlock)[-1].MediumBlockSpanOffsetMultiple := (NativeUInt(APMediumBlock) - NativeUInt(APMediumBlockSpan))
...
{ Inserts a medium block into the appropriate medium block bin.  The header for APMediumFreeBlock must already be set
  correctly. }
procedure InsertMediumBlockIntoBin(APMediumBlockManager: PMediumBlockManager; APMediumFreeBlock: PMediumFreeBlockContent; AMediumBlockSize: Integer);
var
...
begin
  ...
  begin
    ...
    APMediumBlockManager.MediumBlockBinBitmaps[LBinGroupNumber] := APMediumBlockManager.MediumBlockBinBitmaps[LBinGroupNumber] or
      (1 shl (LBinNumber and 31));
    { Flag the group as used }
    APMediumBlockManager.MediumBlockBinGroupBitmap := APMediumBlockManager.MediumBlockBinGroupBitmap or (1 shl LBinGroupNumber);
  end;
end;
...
begin
  ...
  begin
    ...
    if (NativeUInt(LPNextFreeBlock) > NativeUInt(@MediumBlockManagers) + SizeOf(MediumBlockManagers)) or
  ...
  begin
    ...
    APMediumBlockManager.MediumBlockBinBitmaps[LBinGroupNumber] := APMediumBlockManager.MediumBlockBinBitmaps[LBinGroupNumber] and
    ...
    begin
      ...
      APMediumBlockManager.MediumBlockBinGroupBitmap := APMediumBlockManager.MediumBlockBinGroupBitmap and (not(1 shl LBinGroupNumber));
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    if AtomicCmpExchange(APMediumBlockManager.LastMediumBlockSequentialFeedOffset.IntegerValue, 0, LPreviousLastSequentialFeedBlockOffset) = LPreviousLastSequentialFeedBlockOffset
    then
    begin
...
begin
  ...
  if (LBlockSize <> (APMediumBlockSpan.SpanSize - CMediumBlockSpanHeaderSize)) or
    ((OptimizationStrategy <> mmosOptimizeForLowMemoryUsage) and (APMediumBlockManager.LastMediumBlockSequentialFeedOffset.IntegerValue <
    CMaximumMediumBlockSize) and (APMediumBlockManager.MediumBlockBinBitmaps[CMediumBlockBinGroupCount - 1] and (1 shl 31) = 0)) then
  begin
...
begin
  ...
  begin
    ...
    Result := Result or FastMM_FreeMem_InternalFreeMediumBlock_ManagerAlreadyLocked(APMediumBlockManager, LPMediumBlockSpan, APPendingFreeMediumBlock,
...
begin
  ...
  begin
    ...
    begin
      Result := FastMM_FreeMem_InternalFreeMediumBlock_ManagerAlreadyLocked(LPMediumBlockManager, LPMediumBlockSpan, APMediumBlock, True);
    end
    else
    begin
      Result := FastMM_FreeMem_InternalFreeMediumBlock_ManagerAlreadyLocked(LPMediumBlockManager, LPMediumBlockSpan, APMediumBlock, False);
...
function FastMM_GetMem_GetMediumBlock_AllocateNewSequentialFeedSpan(APMediumBlockManager: PMediumBlockManager; AFirstBlockSize: Integer): Pointer;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      LNewLastSequentialFeedBlockOffset.IntegerAndABACounter := LPreviousLastSequentialFeedBlockOffset.IntegerAndABACounter - LBlockSize +
        (Int64(1) shl 32);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if FastMM_FreeMem_InternalFreeMediumBlock_ManagerAlreadyLocked(APMediumBlockManager, LPMediumBlockSpan, Result, False) <> 0 then
        begin
          System.Error(reInvalidPtr);
        end;
      end;
    ...
    begin
      ...
      if FastMM_FreeMem_InternalFreeMediumBlock_ManagerAlreadyLocked(APMediumBlockManager, LPMediumBlockSpan, LPPendingFreeBlock, False) <> 0 then
      begin
        System.Error(reInvalidPtr);
      end;
    end;
  ...
  begin
    ...
    begin
      ...
      if (LPMediumBlockManager.MediumBlockManagerLocked = 0) and
        ((LPMediumBlockManager.PendingFreeList <> nil) or ((LPMediumBlockManager.MediumBlockBinGroupBitmap and LLargerBinGroupsMask) <> 0) or
        ((LPMediumBlockManager.MediumBlockBinBitmaps[LMinimumBlockSizeBinGroupNumber] and LMinimumBlockSizeBinMask) <> 0)) and
        (AtomicExchange(LPMediumBlockManager.MediumBlockManagerLocked, 1) = 0) then
      begin
        ...
        if LPMediumBlockManager.PendingFreeList <> nil then
        begin
          Result := FastMM_GetMem_GetMediumBlock_TryReusePendingFreeBlock(LPMediumBlockManager, AMinimumBlockSize, AOptimalBlockSize,
            AMaximumBlockSize);
          if Result <> nil then
          begin
        ...
        { 1.2) Try to find a suitable free block in the free lists }
        if ((LPMediumBlockManager.MediumBlockBinGroupBitmap and LLargerBinGroupsMask) <> 0) or
          ((LPMediumBlockManager.MediumBlockBinBitmaps[LMinimumBlockSizeBinGroupNumber] and LMinimumBlockSizeBinMask) <> 0) then
        begin
          Exit(FastMM_GetMem_GetMediumBlock_AllocateFreeBlockAndUnlockArena(LPMediumBlockManager, LMinimumBlockSizeBinNumber, AOptimalBlockSize,
            AMaximumBlockSize));
        end;
...
begin
  ...
  begin
    ...
    begin
      ...
      LPMediumBlockManager := LPMediumBlockSpan.MediumBlockManager;
      if (LPMediumBlockManager.MediumBlockManagerLocked = 0) and (AtomicExchange(LPMediumBlockManager.MediumBlockManagerLocked, 1) = 0) then
      begin
        ...
        begin
          ...
          LNewBlockSize := ((LNewAllocSize + (CMediumBlockHeaderSize + CMediumBlockAlignment - 1)) and -CMediumBlockAlignment);
...
begin
  ...
  begin
    ...
    LNewBlockSize := ((ANewUserSize + (CMediumBlockHeaderSize + CMediumBlockAlignment - 1)) and -CMediumBlockAlignment);
...
begin
  ...
  begin
    ...
    begin
      PSmallBlockHeader(APSmallBlock)[-1].BlockStatusFlagsAndSpanOffset :=
        ((NativeInt(APSmallBlock) - NativeInt(APSmallBlockSpan)) and -CMediumBlockAlignment) shr CSmallBlockSpanOffsetBitShift + CIsSmallBlockFlag;
    end;
...
begin
  Result := Pointer((NativeInt(APSmallBlock) and -CMediumBlockAlignment) - (CDropSmallBlockFlagsMask and PBlockStatusFlags(APSmallBlock)[-1])
...
function FastMM_FreeMem_FreeSmallBlock_ManagerAlreadyLocked(APSmallBlockSpan: PSmallBlockSpanHeader; APSmallBlock: Pointer;
...
function FastMM_FreeMem_FreeSmallBlockChain(APPendingFreeSmallBlock: Pointer; AUnlockSmallBlockManagerWhenDone: Boolean): Integer;
var
  LPNextBlock     : Pointer;
...
begin
  ...
  begin
    ...
    FastMM_FreeMem_FreeSmallBlock_ManagerAlreadyLocked(LPSmallBlockSpan, APPendingFreeSmallBlock, AUnlockSmallBlockManagerWhenDone and
      (LPNextBlock = nil));
...
begin
  LPSmallBlockSpan := FastMM_GetMem_GetMediumBlock(APSmallBlockManager.MinimumSpanSize, APSmallBlockManager.OptimalSpanSize,
    APSmallBlockManager.OptimalSpanSize + CSmallBlockSpanMaximumAmountWithWhichOptimalSizeMayBeExceeded);
  ...
  { Calculate the number of small blocks that will fit inside the span.  We need to account for the span header, as well
    ...
    fed sequentially. }
  LTotalBlocksInSpan := (LSpanSize - (CSmallBlockSpanHeaderSize + CMediumBlockHeaderSize - CSmallBlockHeaderSize)) div APSmallBlockManager.BlockSize;
...
function FastMM_GetMem_GetSmallBlock_ReusePendingFreeBlockAndUnlockArena(APSmallBlockManager: PSmallBlockManager): Pointer;
{$IFDEF X86ASM}
asm
  push esi
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if ((APSmallBlockManager.PendingFreeList <> nil) or (NativeInt(APSmallBlockManager.FirstPartiallyFreeSpan) <> NativeInt(APSmallBlockManager)))
...
begin
  ...
  { Large blocks are already zero filled }
  if (Result <> nil) and (ASize <= (CMaximumMediumBlockSize - CMediumBlockHeaderSize - CDebugBlockHeaderSize -
    CalculateDebugBlockFooterSize(PFastMM_DebugBlockHeader(Result).StackTraceEntryCount))) then
  begin
    FillChar(Result^, ASize, 0);
  end;
end;
...
function FastMM_WalkBlocks(ACallBack: TFastMM_WalkBlocksCallback; AWalkBlockTypes: TFastMM_WalkBlocksBlockTypes; AWalkUsedBlocksOnly: Boolean;
...
begin
  ...
  begin
    ...
    begin
      ...
      while (AtomicCmpExchange(LPLargeBlockManager.LargeBlockManagerLocked, 1, 0) <> 0) and FastMM_WalkBlocks_CheckTimeout(LLockWaitTimeMilliseconds,
  ...
  begin
    ...
    begin
      ...
      LLockWaitTimeMilliseconds := 0;
      while (AtomicCmpExchange(LPMediumBlockManager.MediumBlockManagerLocked, 1, 0) <> 0) and
        FastMM_WalkBlocks_CheckTimeout(LLockWaitTimeMilliseconds, LTimestampMilliseconds, ALockTimeoutMilliseconds) do
      begin
        OS_AllowOtherThreadToRun;
      end;
      ...
      begin
        ...
        begin
          ...
          LLockWaitTimeMilliseconds := 0;
          while (GetMediumBlockSize(LPMediumBlock) = 0) and FastMM_WalkBlocks_CheckTimeout(LLockWaitTimeMilliseconds, LTimestampMilliseconds,
            ALockTimeoutMilliseconds) do
          begin
            OS_AllowOtherThreadToRun;
          end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if (AWalkBlockTypes * [btSmallBlockSpan, btSmallBlock] <> []) and PMediumBlockHeader(LPMediumBlock)[-1].IsSmallBlockSpan then
              begin
                LPSmallBlockManager := PSmallBlockSpanHeader(LPMediumBlock).SmallBlockManager;

                LLockWaitTimeMilliseconds := 0;
                while (AtomicCmpExchange(LPSmallBlockManager.SmallBlockManagerLocked, 1, 0) <> 0) and
                  FastMM_WalkBlocks_CheckTimeout(LLockWaitTimeMilliseconds, LTimestampMilliseconds, ALockTimeoutMilliseconds) do
                begin
                  OS_AllowOtherThreadToRun;
                end;
              ...
              begin
                ...
                begin
                  LLastBlockOffset := CSmallBlockSpanHeaderSize + LPSmallBlockManager.BlockSize *
                    (PSmallBlockSpanHeader(LPMediumBlock).TotalBlocksInSpan - 1);
...
begin
  ...
  FastMM_WalkBlocks(FastMM_GetHeapStatus_CallBack, [btLargeBlock, btMediumBlockSpan, btMediumBlock, btSmallBlockSpan, btSmallBlock], False, @Result);
...
begin
  ...
  Result := (@LCurrentMemoryManager.GetMem <> @InstalledMemoryManager.GetMem) or (@LCurrentMemoryManager.FreeMem <> @InstalledMemoryManager.FreeMem)
    or (@LCurrentMemoryManager.ReallocMem <> @InstalledMemoryManager.ReallocMem) or
    (@LCurrentMemoryManager.AllocMem <> @InstalledMemoryManager.AllocMem) or
    (@LCurrentMemoryManager.RegisterExpectedMemoryLeak <> @InstalledMemoryManager.RegisterExpectedMemoryLeak) or
    (@LCurrentMemoryManager.UnregisterExpectedMemoryLeak <> @InstalledMemoryManager.UnregisterExpectedMemoryLeak);
end;
...
begin
  ...
  if (LBlockContentType > 65535) and (LBlockContentType and (SizeOf(Pointer) - 1) = 0) then
  begin
...
function FastMM_LogStateToFile(const AFilename: string; const AAdditionalDetails: string; ALockTimeoutMilliseconds: Cardinal): Boolean;
const
...
begin
  ...
  begin
    try
      ...
      FastMM_WalkBlocks(FastMM_LogStateToFile_Callback, [btLargeBlock, btMediumBlock, btSmallBlock], True, LPLogInfo, ALockTimeoutMilliseconds);
      ...
      LPTokenPos := AddTokenValue_NativeUInt(LTokenValues, CStateLogTokenAllocatedKB, LMemoryManagerUsageSummary.AllocatedBytes div 1024, LPTokenPos,
        LPStateLogBufferStart);
      LPTokenPos := AddTokenValue_NativeUInt(LTokenValues, CStateLogTokenOverheadKB, LMemoryManagerUsageSummary.OverheadBytes div 1024, LPTokenPos,
        LPStateLogBufferStart);
      AddTokenValue_NativeInt(LTokenValues, CStateLogTokenEfficiencyPercentage, Round(LMemoryManagerUsageSummary.EfficiencyPercentage), LPTokenPos,
        LPStateLogBufferStart);
      LPStateLogPos := SubstituteTokenValues(FastMM_LogStateToFileTemplate, LTokenValues, LPStateLogBufferStart, LPBufferEnd);
      ...
      begin
        ...
        LPTokenPos := AddTokenValue_NativeUInt(LTokenValues, CStateLogTokenClassTotalBytesUsed, LPNode.TotalMemoryUsage, LPTokenBufferStart,
          LPStateLogBufferStart);
        LPTokenPos := AddTokenValue_NativeUInt(LTokenValues, CStateLogTokenClassInstanceCount, LPNode.InstanceCount, LPTokenPos,
          LPStateLogBufferStart);
        ...
        AddTokenValue_BlockContentType(LTokenValues, CEventLogTokenObjectClass, LPNode.BlockContentType, LPTokenPos, LPStateLogBufferStart);
        LPStateLogPos := SubstituteTokenValues(FastMM_LogStateToFileTemplate_UsageDetail, LTokenValues, LPStateLogPos, LPBufferEnd);
      end;
      ...
      begin
        ...
        LPStateLogPos := AppendTextToBuffer(PWideChar(AAdditionalDetails), length(AAdditionalDetails), LPStateLogPos, LPBufferEnd);
      end;
...
begin
  ...
  for i := 0 to 7 do
  begin
    SharingFileMappingObjectName[(high(SharingFileMappingObjectName) - 1) - i] := AnsiChar(CHexDigits[((LProcessID shr (i * 4)) and $F)]);
  end;
end;
...
var
  LPMapAddress: Pointer;
begin
  if (CurrentInstallationState = mmisInstalled) and (not FastMM_InstalledMemoryManagerChangedExternally) and (SharingFileMappingObjectHandle = 0) then
  begin
    { Is any other module already sharing its MM? }
    if FastMM_FindSharedMemoryManager = nil then
    begin
      { Create the memory mapped file }
      SharingFileMappingObjectHandle := CreateFileMappingA(INVALID_HANDLE_VALUE, nil, PAGE_READWRITE, 0, SizeOf(Pointer),
...
function UpdateExpectedLeakList(APLeakList: PPExpectedMemoryLeak; APNewEntry: PExpectedMemoryLeak; AExactSizeMatch: Boolean = True): Boolean;
var
...
begin
  ...
  begin
    ...
    if (LPInsertAfter.LeakAddress = APNewEntry.LeakAddress) and ((LPInsertAfter.LeakedClass = APNewEntry.LeakedClass)) and
      ((LPInsertAfter.LeakSize = APNewEntry.LeakSize) or ((not AExactSizeMatch) and (LPInsertAfter.LeakSize < APNewEntry.LeakSize) and
      ((LPInsertAfter.NextLeak = nil) or (LPInsertAfter.NextLeak.LeakSize > APNewEntry.LeakSize)))) then
    begin
...
begin
  ...
  Result := LockExpectedMemoryLeaksList and UpdateExpectedLeakList(@ExpectedMemoryLeaks.FirstEntryByAddress, @LNewEntry);
...
begin
  ...
  LNewEntry.LeakCount := ACount;
  { Add it to the correct list }
  Result := LockExpectedMemoryLeaksList and UpdateExpectedLeakList(@ExpectedMemoryLeaks.FirstEntryBySizeOnly, @LNewEntry);
  ExpectedMemoryLeaksListLocked := 0;
end;
...
procedure FastMM_PerformMemoryLeakCheck_AddBlockToLeakSummary(APLeakSummary: PMemoryLeakSummary; ABlockUsableSize: NativeInt;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (ALeakSummary.MemoryLeakEntries[LInsertionIndex - 1].BlockUsableSize = LCurEntry.BlockUsableSize) and
        (ALeakSummary.MemoryLeakEntries[LInsertionIndex - 1].BlockContentType > LCurEntry.BlockContentType) then
      begin
        Break;
      end;
...
begin
  ...
  LTokenValues := default (TEventLogTokenValues);
  LPTokenBufferPos := AddTokenValues_GeneralTokens(LTokenValues, @LTokenValueBuffer, @LTokenValueBuffer[high(LTokenValueBuffer)]);
  AddTokenValue(LTokenValues, CEventLogTokenLeakSummaryEntries, @LLeakEntriesText, CharCount(LPBufferPos, @LLeakEntriesText), LPTokenBufferPos,
...
begin
  ...
  FastMM_WalkBlocks(FastMM_PerformMemoryLeakCheck_CallBack, [btLargeBlock, btMediumBlock, btSmallBlock], True, @LLeakSummary);

  { Build the leak summary by walking all the block categories. }
  if (LLeakSummary.LeakCount > 0) and (mmetUnexpectedMemoryLeakSummary in (FastMM_OutputDebugStringEvents + FastMM_LogToFileEvents +
...
var
  LBlockSizeIndex, LSmallBlockSize, LArenaInd, LMinimumSmallBlockSpanSize, LBinInd, LOptimalSmallBlockSpanSize, LBlocksPerSpan,
...
{$IF CLargeBlockManagerSize and 63 <> 0} {$MESSAGE error 'Large block manager size must be a multiple of 64 bytes'} {$ENDIF}
  ...
  begin
    ...
    LMinimumSmallBlockSpanSize := RoundUserSizeUpToNextMediumBlockBin(CMinimumSmallBlocksPerSpan * LSmallBlockSize +
    ...
    begin
      ...
      LPSmallBlockManager.UpsizeMoveProcedure := FastMM_InitializeMemoryManager_GetOptimalMoveProc(LPSmallBlockManager.BlockSize);
...
{$IFNDEF FastMM_DebugLibraryStaticDependency}
  ...
  begin
    ...
    if (@FastMM_GetStackTrace = @FastMM_NoOpGetStackTrace) and Assigned(DebugLibrary_GetRawStackTrace) then
    begin
      FastMM_GetStackTrace := DebugLibrary_GetRawStackTrace;
    end;

    if (@FastMM_ConvertStackTraceToText = @FastMM_NoOpConvertStackTraceToText) and Assigned(DebugLibrary_LogStackTrace_Legacy) then
    begin
...
{$IFNDEF FastMM_DebugLibraryStaticDependency}
  if DebugSupportLibraryHandle = 0 then
    Exit(False);
{$ENDIF}
  if (@FastMM_GetStackTrace = @DebugLibrary_GetRawStackTrace) or (@FastMM_GetStackTrace = @DebugLibrary_GetFrameBasedStackTrace) then
  begin
    FastMM_GetStackTrace := @FastMM_NoOpGetStackTrace;
  end;
...
begin
  ...
  if (@FastMM_GetStackTrace = @FastMM_NoOpGetStackTrace) or (@FastMM_ConvertStackTraceToText = @FastMM_NoOpConvertStackTraceToText) then
  begin
...
begin
  ...
  if [mmetUnexpectedMemoryLeakDetail, mmetUnexpectedMemoryLeakSummary] *
    (FastMM_OutputDebugStringEvents + FastMM_LogToFileEvents + FastMM_MessageBoxEvents) <> [] then
